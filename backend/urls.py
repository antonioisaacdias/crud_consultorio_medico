...
urlpatterns = [
    ...
    path('professionals/<uuid:pk>/appointments/', views.professional_appointments, name='professionals_appointments'),
    path('patients/', views.patients, name='patients'),
    path('patients/<uuid:pk>/', views.patients_detail, name='patient_detail'),
    path('patients/<uuid:pk>/appointments/', views.patient_appointments, name='patient_appointments'),
    path('appointments/', views.appointments, name='appointments'),
    path('appointments/<uuid:pk>/', views.appointments_detail, name='appointments_detail'),
    path('appointments/<str:datetime>', views.appointments_by_date, name='appointments_by_date'),
]